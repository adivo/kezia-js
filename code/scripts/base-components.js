define(["common", "tags"], function (Common, Tags) {
    ...
    var moduleIdIterator = 100;
    /** Id iterator for popups */
    var modulePopupIdIterator=0;
    ...
    var registerComponentForAttaching = function (component) {
        componentsToAttach[componentsToAttach.length] = component;
    ...
    var attachRegisteredComponents = function () {
        for (i = 0; i < componentsToAttach.length; i++) {
            componentsToAttach[i].isAttached = true;
            componentsToAttach[i].onAttached();
        }
        componentsToAttach = [];
    }
    /**
    ...
    var Popup = Class.extend({
        ...
        create: function () {
            ...
            this.popupEl.id = 'Popup_'+modulePopupIdIterator++;
