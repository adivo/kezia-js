...
//                this.hasBorderBox = true;
        ...
        this.render = function (positionStyles) {
            ...
            return new Tags.Div(componentInner).id(this.id + "_p")
                    .setName(this.name)
                    .addClass(this.additionalClass).addClass(this.slotStyleClass)
...
//        init: function (text, styleObj, htmlTag, cssClass) {
//            if (Common.isDef(text)&& Common.isUndef(styleObj) && Common.isUndef(htmlTag) ) {
//                this._super(cssClass, text);
//            }else if (Common.isUndef(htmlTag) && Common.isUndef(cssClass)) {
//                this.htmlTag = 'div';
//                this._super('Label', styleObj);
//
//            } else {
...
//        },
        ...
        setValueNoRefresh: function (text) {
            this.text = text;
        },
...
//            return new Tags.Tag(this.htmlTag).addClass(this.cssClass).addClass(this.horizontalAlign).renderWithInnerHtml(this.text);
        },
        /**
        ...
        withModel: function (htmlFile) {
            ...
            Common.asyncLoadHtml(htmlFile, function (xmlhttp) {
                ...
                if (Common.isDef(self.refreshComponent)) {
...
//                }
    ...
    m.Text = m.Component.extend({
        /**
         * Creates a new Label object.
         * The style object can contain the following properties:
         * @param {type} text
         * @param {type} styleObj
         * @returns {undefined}
         * 
         * @constructor
         */
        init: function (text, htmlTag, optStyleObj, optCssClass) {
            this._super(optCssClass, optStyleObj);
            this.value = text;
            this.htmlTag = htmlTag;
        },
        onAttached: function () {
        ...
        renderInner: function () {
            m.registerComponentForAttaching(this);
            return new Tags.Tag(this.htmlTag).addClass(this.cssClass).addClass(this.innerStyleClass).renderWithInnerHtml(this.value);
        }
    });
    /**
     * Formats code using http://craig.is/making/rainbows
